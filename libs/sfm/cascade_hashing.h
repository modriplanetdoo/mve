...
private:
    ...
    {
        /**
         * Primary projection matrix. The number of vectors determines the
    ...
    struct LocalData
    {
         ...
         * Each uint64_t is a bit vector which represents the inverted signs of the
         * dot products of the feature vector with the vectors in
         * ProjMats::prim_proj_mat.
         */
